...
/* =========================
   ABSTRACT ACCEPTED MAIL
========================= */
export async function abstractAcceptedMail({ to, fullName, eventName }) {
  try {
    await postToScript({
      to,
      subject: `Abstract Accepted | ${eventName} | PRAVAHA 2K26`,
      html: `
<!DOCTYPE html>
<html>
  <body style="margin:0; padding:0; background:#050814; font-family:Arial, Helvetica, sans-serif;">
    <div style="padding:28px;">
      <div style="max-width:620px; margin:auto; background:#0b1025; border-radius:18px; padding:32px; color:#ffffff;">
        <div style="text-align:center;">
          <h1 style="margin:0; color:#22d3ee; letter-spacing:1px;">PRAVAHA 2K26</h1>
          <p style="margin-top:6px; color:#94a3b8; font-size:13px;">Paper Presentation — Abstract Review</p>
        </div>
        <hr style="border:none; border-top:1px solid #1e293b; margin:26px 0;" />
        <p style="font-size:15px;">Dear <strong>${fullName}</strong>,</p>
        <p style="font-size:15px; line-height:1.6;">
          🎉 Congratulations! Your abstract for <strong style="color:#22d3ee;">${eventName}</strong> has been
          <strong style="color:#22c55e;">accepted</strong> by our review team.
        </p>
        <div style="background:#022c22; border:1px solid #14532d; border-radius:14px; padding:18px; margin:22px 0; text-align:center;">
          <p style="margin:0 0 6px; font-size:15px; font-weight:bold;">✅ Next Step: Complete Your Payment</p>
          <p style="margin:0; font-size:13px; color:#94a3b8;">Please revisit the Paper Presentation registration page to proceed with the payment and complete your registration.</p>
        </div>
        <p style="margin-top:34px; font-size:13px; color:#94a3b8; text-align:center;">— Team PRAVAHA 2K26<br/>RGMCET</p>
      </div>
    </div>
    ...
    console.log("✅ Abstract accepted mail sent to", to);
  } catch (err) {
    console.error("❌ Abstract Accepted Mail Error:", err.message);
  }
}

/* =========================
   ABSTRACT REJECTED MAIL
========================= */
export async function abstractRejectedMail({ to, fullName, eventName }) {
  try {
    await postToScript({
      to,
      subject: `Abstract Update | ${eventName} | PRAVAHA 2K26`,
      html: `
<!DOCTYPE html>
<html>
  <body style="margin:0; padding:0; background:#050814; font-family:Arial, Helvetica, sans-serif;">
    <div style="padding:28px;">
      <div style="max-width:620px; margin:auto; background:#0b1025; border-radius:18px; padding:32px; color:#ffffff;">
        ...
        <p style="font-size:15px;">Dear <strong>${fullName}</strong>,</p>
        <p style="font-size:15px; line-height:1.6;">
          We regret to inform you that your abstract for <strong>${eventName}</strong> has been
          <strong style="color:#ef4444;">rejected</strong> after review.
        </p>
        <p style="font-size:15px; line-height:1.6;">
          You are welcome to revise and resubmit your abstract by revisiting the Paper Presentation registration page.
        </p>
        <p style="margin-top:34px; font-size:13px; color:#94a3b8; text-align:center;">— Team PRAVAHA 2K26<br/>RGMCET</p>
      </div>
    </div>
    ...
    console.log("✅ Abstract rejected mail sent to", to);
  } catch (err) {
    console.error("❌ Abstract Rejected Mail Error:", err.message);
  }
}
...
export default {
  ...
  sendPaymentApprovalMail,
  transactionRejectedMail,
  abstractAcceptedMail,
  abstractRejectedMail,
};

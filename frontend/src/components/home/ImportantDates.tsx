...
const schedule = [
  {
    ...
    events: [
      ...
      { time: "12:00 PM", activity: "Logo Craft" },
  ...
  },
  {
    ...
    accent: "accent",
    events: [
      { time: "10:00 AM", activity: "EV Spark" },
      { time: "10:00 AM", activity: "Circuit Twisting" },
       { time: "10:00 AM", activity: "Pragma" },
       { time: "12:00 PM", activity: "Lunch Break" },
      { time: "12:30 PM", activity: "Codethon" },
      { time: "1:00 PM", activity: "Guest Lecture" },
